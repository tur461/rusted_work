...
const LIBC_SOL_IP: libc::c_int = 0;
const LIBC_SOL_IPV6: libc::c_int = 41;
const LIBC_SO_ORIGINAL_DST: libc::c_int = 80;
const LIBC_IP6T_SO_ORIGINAL_DST: libc::c_int = 80;
